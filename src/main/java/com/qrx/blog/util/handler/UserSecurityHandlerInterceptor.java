package com.qrx.blog.util.handler;
...
import com.qrx.blog.util.jwt.UserSecurityUtil;
...
public class UserSecurityHandlerInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (!check) {
            writeResponse(response, HttpStatus.UNAUTHORIZED, AjaxResult.unauthorizedError());
            return check;
        }
