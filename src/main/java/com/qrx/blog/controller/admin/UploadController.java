...
public class UploadController {
    ...
    @ResponseBody
    public AjaxResult upload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file) throws URISyntaxException {
        ...
        try {
            ...
            return AjaxResult.success("获取成功", "/upload/" + newFileName);
        } catch (IOException e) {
            e.printStackTrace();
